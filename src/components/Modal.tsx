...
export default function Modal({ onClose, children }: { onClose: () => void; children: ReactNode }) {
  ...
  return (
    <div
      className="fixed inset-0 bg-ink/50 z-[100] grid place-items-center p-5 backdrop-blur-sm animate-fade-in"
      onClick={onOverlayClick}
    >
      <div className="w-[min(560px,100%)] max-h-[90vh] overflow-y-auto bg-surface rounded-xl p-7 relative shadow-lg border border-line animate-slide-up">
        <button
