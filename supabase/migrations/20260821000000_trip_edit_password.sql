...
-- Non-destructive: existing trips get edit_password_hash = null, meaning "no password required",
-- so existing edit share links keep working exactly as before until an owner opts in.
